...
def main():
    ...
    lines += [
        ...
        "",
        "  1. Verify the API is live and add to the plan file this guard's",
        "     own verified-annotation (see API_VERIFIED_ANNOTATION in this",
        "     file), naming the date confirmed reachable.",
        "",
        "  2. Acknowledge unverified and document why it's OK, using this",
        "     guard's own unverified-acknowledged annotation (see",
        "     API_UNVERIFIED_OK_ANNOTATION in this file).",
        "",
