...
log ""
log "  4. Install the security cage (separate, deliberate step):"
log "       bash $(dirname "$0")/harden-wsl.sh"
log "     This locks WSL->Windows interop and tightens sudo. Requires your"
log "     password. After install, sudo prompts for password by default and"
log "     /etc/{wsl.conf,fstab,sudoers} become immutable. Verify with:"
log "       bash $(dirname "$0")/verify-cage.sh"
log ""
